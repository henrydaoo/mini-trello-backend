...
public class BoardController {
    ...
    @PostMapping
    public ResponseEntity<BoardResponse> createBoard(Authentication authentication,
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BoardResponse> getBoard(Authentication authentication, @PathVariable Long id) {
    ...
    public ResponseEntity<BoardResponse> addMember(Authentication authentication,
                                                   @PathVariable Long id,
