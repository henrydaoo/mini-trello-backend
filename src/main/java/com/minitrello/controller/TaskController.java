...
public class TaskController {
    ...
    public ResponseEntity<List<TaskResponse>> getTasks(Authentication authentication,
        ...
        return ResponseEntity.ok(taskService.getTasksForList(authentication.getName(), listId, assigneeId));
    }
    ...
    public ResponseEntity<TaskResponse> assignTask(Authentication authentication,
                                                   @PathVariable Long taskId,
    ...
    public ResponseEntity<TaskResponse> moveTask(Authentication authentication,
                                                 @PathVariable Long taskId,
